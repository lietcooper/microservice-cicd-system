...
/** Configures OpenTelemetry SDK for tracing and log export in the server module. */
@Configuration
public class OpenTelemetryConfig {
  ...
  public OpenTelemetry openTelemetry() {
    Resource resource = Resource.getDefault().toBuilder()
        .put(ResourceAttributes.SERVICE_NAME, "cicd-server")
        .build();
  ...
  public Tracer tracer(OpenTelemetry openTelemetry) {
    return openTelemetry.getTracer("cicd-server");
  }
}
